...
import { Eye, EyeOff, GraduationCap, Mail, Lock, AlertCircle, User, Users } from 'lucide-react';
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <select
                  ...
                  value={formData.role}
                  onChange={handleInputChange}
                  className="pl-10 block w-full rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                >
